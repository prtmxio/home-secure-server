...
async function bootstrap() {
    ...
    (0, hub_control_ws_1.attachHubControlWebSocket)(server, env_1.env, realtimeServices.doorLockService, realtimeServices.ingestHubEvent, realtimeServices.cameraRelay);
