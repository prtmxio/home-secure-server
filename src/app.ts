...
import { sendMjpegViewerSignalForHome } from "./modules/device-control/hub-control-ws";
...
export function createRealtimeServices(): RealtimeServices {
  return {
    cameraRelay: new CameraRelay({
      onFirstViewer: (homeId) => sendMjpegViewerSignalForHome(homeId, "start"),
      onLastViewer: (homeId) => sendMjpegViewerSignalForHome(homeId, "stop"),
    }),
